              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      const LabelText(labelText: "User Info"),
                      InkWell(
                          onTap: () {
                  ...
                  const Inputs(value: "email", sectionName: "Email"),
                ],
              ),
            ),
            Panel(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const LabelText(labelText: "Product History"),
                        ...
                        return  SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  padding:
                                      const EdgeInsets.only(right: 4.0, left: 0.0),
                                  child: ProductCard(
